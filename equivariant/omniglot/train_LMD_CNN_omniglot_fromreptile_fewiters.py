...
lmd_hparams = dict(ckpt_path = "/local/scratch/public/hyt35/md-nn-generalization/omniglot_experiments/ckpt/CNNsmall_fromreptile_fewiters",
...
logger = setup_logger('logger', "logs/log_CNNsmall_fromreptile_fewiters.log")
now = datetime.now()
...
model_reptile.load_state_dict(torch.load(lmd_hparams["reptile_path"]))
