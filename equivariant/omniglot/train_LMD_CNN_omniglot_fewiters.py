...
lmd_hparams = dict(ckpt_path = "/local/scratch/public/hyt35/md-nn-generalization/omniglot_experiments/ckpt/CNNsmall_fewiters",
...
logger = setup_logger('logger', "logs/log_fewiters.log")
now = datetime.now()
