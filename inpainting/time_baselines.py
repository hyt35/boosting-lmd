...
if __name__ == '__main__': 
    ...
    for nesterov_ss in ["1e-4", "2e-4", "5e-4", "1e-3", "2e-3", "5e-3"]:
        ...
        np.save(os.path.join(datpath, "nesterov_time"+nesterov_ss), times)
    ...
    for adam_ss in ["1e-3", "2e-3", "5e-3", "1e-2", "2e-2", "5e-2", "1e-1"]:
        ...
        np.save(os.path.join(datpath, "adam_time"+str(adam_ss)), times)
    ...
    for gd_ss in ["2e-4", "5e-4", "1e-3", "2e-3", "5e-3", "1e-2", "2e-2", "5e-2", "1e-1"]:
        ...
        np.save(os.path.join(datpath, "gd_time"+str(gd_ss)), times)
